...
import jp.co.internous.freesia.model.domain.TblCart;
import jp.co.internous.freesia.model.domain.dto.CartDto;
import jp.co.internous.freesia.model.form.CartForm;
import jp.co.internous.freesia.model.mapper.TblCartMapper;
import jp.co.internous.freesia.model.session.LoginSession;

@Controller
@RequestMapping("/freesia/cart")
public class CartController {
	...
	public String index(Model m) {
		...
		int userId = loginSession.getIsLogin() ? loginSession.getUserId() : loginSession.getTemporaryUserId();
